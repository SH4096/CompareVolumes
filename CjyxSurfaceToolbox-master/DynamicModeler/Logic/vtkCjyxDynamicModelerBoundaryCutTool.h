...
protected:
  ...
  virtual void GetSeedPoints(vtkDRMLDynamicModelerNode* surfaceEditorNode, vtkPoints* points);

  /// The default seed point location. Calculated from the center of all input control points
  virtual void GetDefaultSeedPoint(vtkDRMLDynamicModelerNode* surfaceEditorNode, double seedPoint[3]);
