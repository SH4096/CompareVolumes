...
// DRML includes
#include <vtkDRMLMarkupsClosedCurveNode.h>
#include <vtkDRMLMarkupsFiducialNode.h>
#include <vtkDRMLModelNode.h>
#include <vtkDRMLSliceNode.h>
...
//----------------------------------------------------------------------------
vtkToolNewMacro(vtkCjyxDynamicModelerCurveCutTool);
...
//----------------------------------------------------------------------------
vtkCjyxDynamicModelerCurveCutTool::vtkCjyxDynamicModelerCurveCutTool()
{
  /////////
  // Inputs
  ...
  inputCurveEvents->InsertNextTuple1(vtkDRMLMarkupsNode::PointModifiedEvent);
  inputCurveEvents->InsertNextTuple1(vtkDRMLTransformableNode::TransformModifiedEvent);
  vtkNew<vtkStringArray> inputCurveClassNames;
  inputCurveClassNames->InsertNextValue("vtkDRMLMarkupsCurveNode");
  NodeInfo inputCurve(
    "Curve",
  ...
  insidePointListClassNames->InsertNextValue("vtkDRMLMarkupsFiducialNode");
...
//----------------------------------------------------------------------------
const char* vtkCjyxDynamicModelerCurveCutTool::GetName()
{
  return "Curve cut";
}

//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerCurveCutTool::RunInternal(vtkDRMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDRMLModelNode* outputInsideModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(CURVE_CUT_OUTPUT_INSIDE_MODEL_REFERENCE_ROLE));
  vtkDRMLModelNode* outputOutsideModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(CURVE_CUT_OUTPUT_OUTSIDE_MODEL_REFERENCE_ROLE));
  ...
  vtkDRMLModelNode* inputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(CURVE_CUT_INPUT_MODEL_REFERENCE_ROLE));
  ...
  vtkDRMLNode* inputNode = surfaceEditorNode->GetNodeReference(CURVE_CUT_INPUT_CURVE_REFERENCE_ROLE);
  vtkDRMLMarkupsCurveNode* curveNode = vtkDRMLMarkupsCurveNode::SafeDownCast(inputNode);
  if (!curveNode)
    {
  ...
  vtkDRMLMarkupsFiducialNode* insidePointNode = vtkDRMLMarkupsFiducialNode::SafeDownCast(
