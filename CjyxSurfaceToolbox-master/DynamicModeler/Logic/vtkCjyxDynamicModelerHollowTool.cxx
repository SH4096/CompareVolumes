...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerHollowTool::RunInternal(vtkDRMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDRMLModelNode* outputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(HOLLOW_OUTPUT_MODEL_REFERENCE_ROLE));
  if (!outputModelNode)
    {
    // Nothing to output
    return true;
  ...
  vtkDRMLModelNode* inputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(HOLLOW_INPUT_MODEL_REFERENCE_ROLE));
  if (!inputModelNode)
    {
