...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerMirrorTool::RunInternal(vtkDRMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDRMLModelNode* outputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(MIRROR_OUTPUT_MODEL_REFERENCE_ROLE));
  if (!outputModelNode)
    {
    // Nothing to output
    return true;
  ...
  vtkDRMLModelNode* inputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(MIRROR_INPUT_MODEL_REFERENCE_ROLE));
  if (!inputModelNode)
    {
  ...
  vtkDRMLNode* inputNode = surfaceEditorNode->GetNodeReference(MIRROR_INPUT_PLANE_REFERENCE_ROLE);
  vtkDRMLMarkupsPlaneNode* inputPlaneNode = vtkDRMLMarkupsPlaneNode::SafeDownCast(inputNode);
  vtkDRMLSliceNode* inputSliceNode = vtkDRMLSliceNode::SafeDownCast(inputNode);
