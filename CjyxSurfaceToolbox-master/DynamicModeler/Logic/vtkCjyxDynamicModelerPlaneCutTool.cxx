...
vtkCjyxDynamicModelerPlaneCutTool::vtkCjyxDynamicModelerPlaneCutTool()
{
  ...
  inputPlaneEvents->InsertNextTuple1(vtkDRMLMarkupsNode::PointModifiedEvent);
  inputPlaneEvents->InsertNextTuple1(vtkDRMLTransformableNode::TransformModifiedEvent);
  vtkNew<vtkStringArray> inputPlaneClassNames;
  inputPlaneClassNames->InsertNextValue("vtkDRMLMarkupsPlaneNode");
  inputPlaneClassNames->InsertNextValue("vtkDRMLSliceNode");
  NodeInfo inputPlane(
    "Plane node",
...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerPlaneCutTool::RunInternal(vtkDRMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDRMLModelNode* outputPositiveModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(PLANE_CUT_OUTPUT_POSITIVE_MODEL_REFERENCE_ROLE));
  vtkDRMLModelNode* outputNegativeModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(PLANE_CUT_OUTPUT_NEGATIVE_MODEL_REFERENCE_ROLE));
  ...
  std::vector<vtkDRMLNode*> planeNodes;
  ...
  int planeIndex = 0;
  for (vtkDRMLNode* planeNode : planeNodes)
    {
    vtkDRMLMarkupsPlaneNode* inputPlaneNode = vtkDRMLMarkupsPlaneNode::SafeDownCast(planeNode);
    vtkDRMLSliceNode* inputSliceNode = vtkDRMLSliceNode::SafeDownCast(planeNode);
  ...
  vtkDRMLModelNode* inputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(PLANE_CUT_INPUT_MODEL_REFERENCE_ROLE));
  if (!inputModelNode)
    {
  ...
  if (outputPositiveModelNode)
    ...
    DRMLNodeModifyBlocker blocker(outputPositiveModelNode);
    outputPositiveModelNode->SetAndObserveMesh(outputMesh);
    outputPositiveModelNode->InvokeCustomModifiedEvent(vtkDRMLModelNode::MeshModifiedEvent);
    }
  ...
  if (outputNegativeModelNode)
    ...
    DRMLNodeModifyBlocker blocker(outputNegativeModelNode);
    outputNegativeModelNode->SetAndObserveMesh(outputMesh);
    outputNegativeModelNode->InvokeCustomModifiedEvent(vtkDRMLModelNode::MeshModifiedEvent);
    }
