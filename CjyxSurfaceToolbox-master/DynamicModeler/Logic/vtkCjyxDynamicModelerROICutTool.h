...
public:
  ...
  bool RunInternal(vtkDRMLDynamicModelerNode* dynamicModelerNode) override;


  // Inputs

  /// Reference role used for the input model (vtkDRMLModelNode)
  static const char* GetInputModelReferenceRole();
  /// Reference role used for the input ROI (vtkDRMLMarkupsROINode)
  static const char* GetInputROIReferenceRole();


  // Outputs

  /// Reference role used for the output model that is inside the ROI (vtkDRMLModelNode)
  static const char* GetOutputInsideModelReferenceRole();
  /// Reference role used for the output model that is outside the ROI (vtkDRMLModelNode)
  static const char* GetOutputOutsideModelReferenceRole();


  // Parameters

    /// Node attribute that is used to indicate if the output models should be capped (vtkDRMLModelNode)
