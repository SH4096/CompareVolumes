...
// DRML includes
#include <vtkDRMLMarkupsFiducialNode.h>
#include <vtkDRMLModelNode.h>
#include <vtkDRMLTransformNode.h>
#include <vtkDRMLModelDisplayNode.h>
...
//----------------------------------------------------------------------------
vtkToolNewMacro(vtkCjyxDynamicModelerSelectByPointsTool);
...
//----------------------------------------------------------------------------
vtkCjyxDynamicModelerSelectByPointsTool::vtkCjyxDynamicModelerSelectByPointsTool()
{
  /////////
  // Inputs
  vtkNew<vtkIntArray> inputModelEvents;
  inputModelEvents->InsertNextValue(vtkCommand::ModifiedEvent);
  inputModelEvents->InsertNextValue(vtkDRMLModelNode::MeshModifiedEvent);
  inputModelEvents->InsertNextValue(vtkDRMLTransformableNode::TransformModifiedEvent);
  vtkNew<vtkStringArray> inputModelClassNames;
  inputModelClassNames->InsertNextValue("vtkDRMLModelNode");
  NodeInfo inputModel(
    "Model node",
  ...
  inputFiducialListEvents->InsertNextValue(vtkDRMLMarkupsNode::PointModifiedEvent);
  inputFiducialListEvents->InsertNextValue(vtkDRMLTransformableNode::TransformModifiedEvent);
  vtkNew<vtkStringArray> inputFiducialListClassNames;
  inputFiducialListClassNames->InsertNextValue("vtkDRMLMarkupsFiducialNode");
...
//----------------------------------------------------------------------------
const char* vtkCjyxDynamicModelerSelectByPointsTool::GetName()
{
  return "Select by points";
}

//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerSelectByPointsTool::RunInternal(vtkDRMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDRMLModelNode* outputSelectionScalarsModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_OUTPUT_MODEL_WITH_SELECT_BY_POINTS_SCALARS_REFERENCE_ROLE));
  vtkDRMLModelNode* outputSelectedFacesModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_OUTPUT_MODEL_WITH_SELECTED_FACES_REFERENCE_ROLE));
  ...
  vtkDRMLNode* inputNode = surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_INPUT_FIDUCIAL_LIST_REFERENCE_ROLE);
  vtkDRMLMarkupsFiducialNode* fiducialNode = vtkDRMLMarkupsFiducialNode::SafeDownCast(inputNode);
  if (!fiducialNode)
    {
  ...
  vtkDRMLModelNode* inputModelNode = vtkDRMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_INPUT_MODEL_REFERENCE_ROLE));
  if (!inputModelNode)
    {
  ...
  if (computeSelectionScalarsModel)
    ...
    outputSelectionScalarsModelNode->InvokeCustomModifiedEvent(vtkDRMLModelNode::MeshModifiedEvent);
    }
  ...
  if (computeSelectedFacesModel)
    ...
    DRMLNodeModifyBlocker blocker(outputSelectedFacesModelNode);
    outputSelectedFacesModelNode->SetAndObserveMesh(this->SelectedFacesOutputMesh);
    outputSelectedFacesModelNode->InvokeCustomModifiedEvent(vtkDRMLModelNode::MeshModifiedEvent);
    }
...
//----------------------------------------------------------------------------
void vtkCjyxDynamicModelerSelectByPointsTool::CreateOutputDisplayNodes(vtkDRMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  if (outputSelectionScalarsModelNode && !outputSelectionScalarsModelNode->GetModelDisplayNode())
    ...
    vtkDRMLModelDisplayNode* outputDisplayNode = outputSelectionScalarsModelNode->GetModelDisplayNode();
    outputDisplayNode->SetActiveScalar(SELECTION_ARRAY_NAME, vtkAssignAttribute::POINT_DATA);
    outputDisplayNode->SetAndObserveColorNodeID("vtkDRMLColorTableNodeFileViridis.txt");
  ...
  if (inputModelNode && outputSelectedFacesModelNode && !outputSelectedFacesModelNode->GetModelDisplayNode())
    ...
    vtkDRMLModelDisplayNode* outputDisplayNode = outputSelectedFacesModelNode->GetModelDisplayNode();
    vtkDRMLModelDisplayNode* inputDisplayNode = inputModelNode->GetModelDisplayNode();
    outputDisplayNode->SetColor(inputDisplayNode->GetColor());
    }
}

//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerSelectByPointsTool::UpdateUsingSphereRadius(vtkPolyData* inputMesh_World, vtkDRMLMarkupsFiducialNode* fiducialNode,
...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerSelectByPointsTool::UpdateUsingGeodesicDistance(vtkPolyData* inputMesh_World, vtkDRMLMarkupsFiducialNode* fiducialNode,
