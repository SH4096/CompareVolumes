...
class vtkDRMLMarkupsFiducialNode;
...
public:
  ...
  bool RunInternal(vtkDRMLDynamicModelerNode* surfaceEditorNode) override;

  void CreateOutputDisplayNodes(vtkDRMLDynamicModelerNode* surfaceEditorNode) override;
  
protected:

  // Uses cached locator
  bool UpdateUsingSphereRadius(vtkPolyData* inputMesh_World, vtkDRMLMarkupsFiducialNode* fiducialNode,
  ...
  bool UpdateUsingGeodesicDistance(vtkPolyData* inputMesh_World, vtkDRMLMarkupsFiducialNode* fiducialNode,
    double selectionDistance, bool computeSelectionScalarsModel, bool computeSelectedFacesModel,
    vtkUnsignedCharArray* outputSelectionArray, vtkSmartPointer<vtkPolyData>& selectedFacesMesh_World);
