...
public:
  ...
  /// and gets a confidence value for a certain DRML node (usually the type and possibly attributes are checked).
  ...
  double canAddNodeToSubjectHierarchy(
    vtkDRMLNode* node,
    vtkIdType parentItemID=vtkDRMLSubjectHierarchyNode::INVALID_ITEM_ID )const override;
